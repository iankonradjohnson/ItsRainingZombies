...
public class OVRGrabbable : MonoBehaviour
{
    ...
    virtual public void GrabBegin(OVRGrabber hand, Collider grabPoint)
    {
        ...
        gameObject.transform.position = hand.GetComponentsInChildren<Transform>()[1].position;// GetComponentInChildren<Transform>().position;
        gameObject.transform.rotation = hand.transform.rotation * Quaternion.Euler(0, 0, 90);
        //gameObject.transform.rotation = snapOffset.rotation;
